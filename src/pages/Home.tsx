      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: '전문성', desc: '15년 경력의 보험사 출신 전문보험\n설계사가 직접 분석합니다.', icon: <Award className="w-8 h-8" /> },
              { title: '투명성', desc: '고객과 소통하며 고객에게 투명하게\n맞춤형설계를 합니다.', icon: <CheckCircle2 className="w-8 h-8" /> },
              { title: '결과 중심', desc: '한번 고객은 끝까지 관리 책임지는\n보험설계사가 되겠습니다.', icon: <Users className="w-8 h-8" /> },
            ].map((item, i) => (
