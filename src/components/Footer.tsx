...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-20 px-6 md:px-12 lg:px-24">
      ...
      {/* 💡 요청하신 글로벌금융판매 준법감시인 심의필 고지문 완전 삽입 영역 */}
      <div className="max-w-7xl mx-auto mt-6 pt-6 border-t border-gray-800/50 text-center md:text-left text-gray-400 text-xs md:text-sm leading-relaxed whitespace-pre-line">
        <p>
          (주)글로벌 금융 판매 대리점 등록번호 제 2009091278 호 보험설계사 박철호 (생명,손해보험협회 등록번호 제20130574120019호) <br />
          (주)글로벌금융판매 준법감시인 심의필 제 26-05-1489호 (2026-05-21 ~ 2027-05-20) *본 광고는 광고심의기준을 준수하였으며, 유효기간은 심의일로부터 1년입니다. <br /><br />
          
          <strong>[금융상품판매 대리·중개 업무 관련 안내]</strong><br />
          (주)글로벌금융판매 박철호 은(는) 다수의 보험회사의 보험모집위탁계약을 체결한 법인보험대리점 소속 보험설계사입니다. 박철호 은(는) 직접 보험계약을 체결하거나 보험회사를 대리하여 보험계약의 승낙 , 변경 등 의사표시를 할 수 있는 권한 , 보험료영수권을 가지지 아니하며 보험계약의 체결 인수여부 심사 및 결정 권한은 보험회사에 있습니다. <br /><br />
          
          <strong>[모집종사자 개인 의견 안내]</strong><br />
          상기 내용은 (주)글로벌금융판매 박철호 의 개인의견이며, 계약 체결에 따른 이익 또는 손실은 보험 계약자 등에게 귀속됩니다. <br /><br />
          
          <strong>[승환계약 관련 유의 안내]</strong><br />
          보험계약자가 기존 보험계약을 해지하고 새로운 보험계약을 체결하는 과정에서 ①질병이력, 연령증가 등으로 가입이 거절 되거나 보험료가 인상될 수 있습니다. ②가입 상품에 따라 새로운 면책기간 적용 및 보장 제한 등 기타 불이익이 발생할 수 있습니다.
        </p>
      </div>
    </footer>
  );
